...
network policy name and namespace to view corresponding flow throughput under network policy. When
hovering over the flow, it will show corresponding Pod-to-Pod traffic and network policies.
