...
- **antrea_agent_deny_connection_count:** Number of deny connections detected by
Flow Exporter deny connections tracking. This metric gets updated when a flow is
rejected/dropped by network policy.
