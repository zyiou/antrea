...
// SetTCPsPort sets the source port in the packet's TCP header.
func (b *ofPacketOutBuilder) SetTCPsPort(port uint16) PacketOutBuilder {
...
// SetTCPdPort sets the destination port in the packet's TCP header.
func (b *ofPacketOutBuilder) SetTCPdPort(port uint16) PacketOutBuilder {
	if b.pktOut.TCPHeader == nil {
		b.pktOut.TCPHeader = new(protocol.TCP)
	}
...
// SetUDPsPort sets the source port in the packet's UDP header.
func (b *ofPacketOutBuilder) SetUDPsPort(port uint16) PacketOutBuilder {
...
// SetUDPdPort sets the destination port in the packet's UDP header.
func (b *ofPacketOutBuilder) SetUDPdPort(port uint16) PacketOutBuilder {
	if b.pktOut.UDPHeader == nil {
		b.pktOut.UDPHeader = new(protocol.UDP)
	}
