...
// Source: github.com/vmware-tanzu/antrea/pkg/agent/flowexporter/connections (interfaces: ConntrackConnectionStore,ConnTrackDumper,NetFilterConnTrack)
...
// MockConntrackConnectionStore is a mock of ConntrackConnectionStore interface
type MockConntrackConnectionStore struct {
	ctrl     *gomock.Controller
	recorder *MockConntrackConnectionStoreMockRecorder
}

// MockConntrackConnectionStoreMockRecorder is the mock recorder for MockConntrackConnectionStore
type MockConntrackConnectionStoreMockRecorder struct {
	mock *MockConntrackConnectionStore
}

// NewMockConntrackConnectionStore creates a new mock instance
func NewMockConntrackConnectionStore(ctrl *gomock.Controller) *MockConntrackConnectionStore {
	mock := &MockConntrackConnectionStore{ctrl: ctrl}
	mock.recorder = &MockConntrackConnectionStoreMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockConntrackConnectionStore) EXPECT() *MockConntrackConnectionStoreMockRecorder {
	return m.recorder
}

// SetExportDone mocks base method
func (m *MockConntrackConnectionStore) SetExportDone(arg0 flowexporter.ConnectionKey) error {
	m.ctrl.T.Helper()
...
func (mr *MockConntrackConnectionStoreMockRecorder) SetExportDone(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetExportDone", reflect.TypeOf((*MockConntrackConnectionStore)(nil).SetExportDone), arg0)
}
